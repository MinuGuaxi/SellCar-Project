...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/resultadosPesquisa',
          builder: (context, params) => ResultadosPesquisaWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'Perto_Vc',
          path: '/pertoVc',
          builder: (context, params) => PertoVcWidget(),
        ),
        FFRoute(
          name: 'Sobre',
          path: '/sobre',
        ...
        FFRoute(
          name: 'Tela_anuncio',
          path: '/telaAnuncio',
          builder: (context, params) => TelaAnuncioWidget(),
        ),
        FFRoute(
          name: 'fazer_anuncio',
          path: '/fazerAnuncio',
          builder: (context, params) => FazerAnuncioWidget(),
        ),
        FFRoute(
          name: 'favoritos',
          path: '/favoritos',
