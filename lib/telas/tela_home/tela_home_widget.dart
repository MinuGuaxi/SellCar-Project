                ...
                children: [
                      ...
                      builder: (BuildContext context,
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            final carro =
                                carros[index].data() as Map<String, dynamic>;
                  ...
                  Container(
                    margin: EdgeInsets.symmetric(
                        horizontal:
                            16.0), // Define a margem horizontal de 16 pixels
                    child: Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        'Próximo de você:',
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        width: 100,
                                        height: 50,
                                        child: Image.network(carro[
                                            'fotoUrl']), // Substitua o Placeholder pela sua imagem do carro
                                      ),
                                      Expanded(
                                        child: Padding(
